...
export const MemoryPatternCard: React.FC<MemoryPatternCardProps> = ({
  patternType,
  name,
  description,
  occurrences,
  ...
  return (
    <div className="p-4 rounded-xl bg-gaming-panel border border-gaming-border hover:border-gaming-red/40 transition-all clip-chamfer-sm space-y-3">
      <div className="flex items-center justify-between">
        ...
        <span className="text-[10px] font-mono px-2 py-0.5 rounded bg-gaming-carbon text-gaming-slate border border-gaming-border uppercase">
      ...
      <div className="grid grid-cols-3 gap-2 p-2 rounded-lg bg-gaming-carbon border border-gaming-border text-center font-mono">
        <div>
          <span className="text-[9px] uppercase text-gaming-slate block">Observations</span>
          <span className="text-xs font-bold text-gaming-white">{occurrences}x</span>
        </div>
        <div>
          <span className="text-[9px] uppercase text-gaming-slate block">Confidence</span>
          <span className="text-xs font-bold text-gaming-red-bright">{(confidence * 100).toFixed(0)}%</span>
        </div>
        <div>
          <span className="text-[9px] uppercase text-gaming-slate block">Impact</span>
      ...
      <div className="p-2.5 rounded-lg bg-gaming-carbon/80 border border-gaming-red/20 space-y-1">
        ...
        <p className="text-[11px] text-gaming-white leading-relaxed">
          {recommendation}
        </p>
      </div>
    </div>

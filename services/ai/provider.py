...
class LLMCapabilities(BaseModel):
    ...
    model_name: str
    is_local: bool = True
    hardware_target: str = "CPU/GPU"  # e.g., "NPU (Hexagon)", "NVIDIA CUDA", "CPU", "Local Endpoint"
    context_length: int = 8192
    supports_tools: bool = True
    is_available: bool = False
    provenance: str = "MEASURED"  # "MEASURED" | "ESTIMATED" | "FALLBACK" | "DEMO"
...
class LocalLLMProvider(ABC):
    ...
    def capabilities(self) -> LLMCapabilities:
        """Return provider hardware and model capabilities."""
        pass
    ...
    def generate(
        ...
        """Execute text generation with reasoning."""
        pass
